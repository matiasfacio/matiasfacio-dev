    ...
    <ContactContainer>
      ...
      <Impressum>
        ...
        <div>
          ...
          <br />
          <br />
          Anschrift: Stargarder Str. 74, 10437, Berlin
          <br />
          <br />
          KONTAKT:
          <br />
          Email-Adresse: matiaspersonal@gmail.com
          <br />
          <br />
          ...
          genannte Web Fonts, die von Drittanbietern bereitgestellt werden. Beim
          ...
          wurde. Die Nutzung von Web Fonts erfolgt im Interesse einer
...
`;
const Telephone = styled(ContactData)`
 
`;

const Email = styled(ContactData)`
